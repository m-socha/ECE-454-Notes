...
\begin{document}
  ...
  \section{Apache ZooKeeper}
    ...
    \subsection{Node Types}
      Two major types of nodes are:
      \begin{itemize}
        \item \textbf{Ephemeral nodes}, which exist as long as the session that created them is active, unless they were explicitly deleted.
        \item \textbf{Sequence nodes}, which append a monotonically increasing counter to the end of their path.
      \end{itemize}
